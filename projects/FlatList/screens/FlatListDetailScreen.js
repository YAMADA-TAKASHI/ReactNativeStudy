...
import { StyleSheet,Alert,View,Text,Animated,Dimensions,TouchableWithoutFeedback} from 'react-native';
import { WebView } from "react-native-webview"; //pod installが必要
export default class FlatListDetailScreen extends React.Component {
    ...
    render() {
        ...
        return (
            ...
            <WebView
                ...
                source={{html: this.props.navigation.state.params.article.content}}
